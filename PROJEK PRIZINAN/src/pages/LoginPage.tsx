...
export function LoginPage() {
  ...
  const handleSubmit = async (
    ...
    // biarkan AuthContext menangani session.
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-stone-500 mt-1">
            Sistem Pencatatan Perizinan Pesantren
          </p>
        ...
        <div className="card p-6 sm:p-8 animate-slide-up">
          ...
          {mode === 'signup' && (
            <p className="text-xs text-stone-500 mb-4 text-center">
              Pengguna pertama yang mendaftar otomatis menjadi
              Super Admin
            </p>
          )}
          ...
          >
            ...
            {displayedError && (
              <div className="flex items-start gap-2 p-3 rounded-xl bg-red-50 border border-red-100 text-red-700 text-sm animate-fade-in">
